...
use Altamira\JsWriter\Ability\Shadowable;
use Altamira\JsWriter\Ability\Fillable;
use Altamira\JsWriter\Ability\Labelable;
use Altamira\JsWriter\Ability\Lineable;
...
class Series
{
     ...
     */
    public function __construct($data, $title, JsWriterAbstract $jsWriter)
    {
        self::$count++;
    ...
    public function setShadow($opts = array('use' => true,
        ...
        'alpha' => 0.1))
    {
        if ($this->jsWriter instanceOf Shadowable) {
    ...
    public function setFill($opts = array('use' => true,
        ...
        'alpha' => null))
    {
        if ($this->jsWriter instanceOf Fillable) {
    ...
    {
        if ($this->jsWriter instanceOf Labelable) {
    ...
    {
        if ($this->jsWriter instanceof Lineable) {
     ...
     * @return \Altamira\Series provides fluent interface
     */
    public function setType(TypeAbstract $type)
    {
