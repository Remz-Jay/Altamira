...
use AltaMira\JsWriter\Ability\Cursorable;
...
class Chart
{
     ...
     * @throws \Exception
     */
    public function __construct($name, $library = JqPlot::LIBRARY)
    {
        if (empty($name)) {
    ...
    public function useCursor()
    {
        ...
        if (!$this->jsWriter instanceOf Cursorable) {
     ...
     * @return \Altamira\Chart provides fluent interface
     */
    public function setType(TypeAbstract $type, $seriesTitle = null)
    {
