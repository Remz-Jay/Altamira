...
abstract class JsWriterAbstract
{
    ...
    public function getFiles()
    {
        ...
        $path = Config::getInstance()->getPluginPath($this->getLibrary());
    ...
    {
        return ($series instanceof Series) ? $series->getTitle() : $series;
    }
     ...
     * @return $this
     */
    public function setType(TypeAbstract $type, $options = array(), $series = 'default')
    {
